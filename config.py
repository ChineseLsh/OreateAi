...
BROWSER_HEADLESS = _env_bool("THREADAI_BROWSER_HEADLESS", False)
BROWSER_TIMEOUT_MS = _env_int("THREADAI_BROWSER_TIMEOUT_MS", 30_000)
BROWSER_RISK_TIMEOUT_MS = _env_int("THREADAI_BROWSER_RISK_TIMEOUT_MS", 5_000)
